...
with col1:
    st.image("https://github.com/elioramospr/hola_streamlit_mj/blob/main/logouprh.png?raw=true",width=150)

with col2:
    st.title("Datos de Covid - Variante Omicrón")
    
with col3:
    st.image("https://github.com/elioramospr/hola_streamlit_mj/blob/main/covid.png?raw=true",width=150)
